...
var items = [  
    ...
    <SlideImgItem imgURL={"/assets/img/portfolio/Image 14.png"} imgLink={"https://museudastoninhas.com.br/"} skillContent={"Web Virtual Reality : VR + WebGL + Next.js + TypeScript + Node.js"} key="4" />,
